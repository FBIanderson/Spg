    ...
    while i < len(list_tuple_results_back):
        ...
        if iter_time == 3 or iter_time == -1:#allow cross 3 funcs:
            ...
            if list_node[1]['type'] == 'Parameter':   
                ...
                path = os.path.join('/home/zheng/Desktop/locator_dict/26/dict_call2cfgNodeID_funcID', testID, 'dict.pkl')
                ...
                if funcname.find("::") > -1:
                    ...
                    path = os.path.join('/home/zheng/Desktop/locator_dict/26/dict_call2cfgNodeID_funcID', testID, 'dict.pkl')#get funname and it call place
                    fin = open(path, 'rb')
                    _dict = pickle.load(fin)
                    fin.close()
