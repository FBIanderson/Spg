...
def get_slice_file_sequence(store_filepath, list_result, count, func_name, startline, filepath_all):
    ...
    #f.write('qemu/' + path2 + '/(' + startline + ',' + integename + ')' + '\n')
...
def api_slice():
    count = 1
    store_filepath = "/home/zheng/Desktop/expslice/api_slices.txt"
    f = open("/home/zheng/Desktop/exppoint/sensifunc_slice_points.pkl", 'rb')
            ...
            if sensitive_funcname.find("main") != -1:
                ...
                if list_code == []:
                    ...
                    '''
                        i = 0
                        while i<len(_list):
                            with open("/home/zheng/Desktop/list.txt", 'a+') as f:
                                f.write(str(_list[i]) + '\n')
                            i = i + 1
    ...
    '''
    for r in record:
        with open('/home/zheng/Desktop/FFMslice/apirecord/0/JOERNrecord.txt', 'a+') as record_file:
            for ri in r:
                record_file.write(str(ri) + '\n')
            record_file.write('----------------------------\n')
    for l in label:
        with open('/home/zheng/Desktop/FFMslice/apirecord/0/JOERNreal-mvd.txt', 'a+') as label_file:
                label_file.write(str(l) + '\n')
    '''

def pointers_slice():
    count = 1
    store_filepath = "/home/zheng/Desktop/expslice/pointersuse_slices.txt"
    f = open("/home/zheng/Desktop/exppoint/pointuse_slice_points.pkl", 'rb')
    ...
    '''
    for r in record:
        with open('/home/zheng/Desktop/pointrecord/9/JOERNrecord.txt', 'a+') as record_file:
            for ri in r:
                record_file.write(str(ri) + '\n')
            record_file.write('----------------------------\n')
    for l in label:
        with open('/home/zheng/Desktop/pointrecord/9/JOERNreal-mvd.txt', 'a+') as label_file:
                label_file.write(str(l) + '\n')
    '''

def return_slice():
    count = 1
    store_filepath = "/home/zheng/Desktop/expslice/returnuse_slices.txt"
    f = open("/home/zheng/Desktop/exppoint/return_slice_points_new.pkl", 'rb')
    dict_unsliced_pointers = pickle.load(f)
    #print dict_unsliced_pointers
    f.close()
    record = []
...
def param_slice():
    count = 1
    store_filepath = "/home/zheng/Desktop/expslice/paramsuse_slices.txt"
    f = open("/home/zheng/Desktop/exppoint/param_slice_points_new.pkl", 'rb')
    dict_unsliced_pointers = pickle.load(f)
    #print dict_unsliced_pointers
    f.close()
    record = []
...
def arrays_slice():
    count = 1
    store_filepath = "/home/zheng/Desktop/expslice/arraysuse_slices.txt"
    f = open("/home/zheng/Desktop/exppoint/arrayuse_slice_points.pkl", 'rb')
    dict_unsliced_pointers = pickle.load(f)
    f.close()
    ...
    for key in tqdm.tqdm(dict_unsliced_pointers.keys()):#key is testID
        ...
        #for _t in dict_unsliced_pointers[key]:
            ...
            if len(recordtemp) != 0:
                ...
                label.append(labell)
    for r in record:
        with open('/home/zheng/Desktop/arrayrecord/9/JOERNrecord.txt', 'a+') as record_file:
            for ri in r:
                record_file.write(str(ri) + '\n')
            record_file.write('----------------------------\n')
    for l in label:
        with open('/home/zheng/Desktop/arrayrecord/9/JOERNreal-mvd.txt', 'a+') as label_file:
                label_file.write(str(l) + '\n')
            '''

def integeroverflow_slice():
    count = 1
    store_filepath = "/home/zheng/Desktop/expslice/integeroverflow_slices.txt"
    f = open("/home/zheng/Desktop/exppoint/integeroverflow_slice_points_new.pkl", 'rb')
    ...
    for key in tqdm.tqdm(dict_unsliced_expr.keys()):#key is testID
        ...
        #for _t in dict_unsliced_expr[key]:
            ...
            if len(recordtemp) != 0:
                ...
                label.append(labell)
    for r in record:
        with open('/home/zheng/Desktop/integerecord/9/JOERNrecord.txt', 'a+') as record_file:
            for ri in r:
                record_file.write(str(ri) + '\n')
            record_file.write('----------------------------\n')
    for l in label:
        with open('/home/zheng/Desktop/integerecord/9/JOERNreal-mvd.txt', 'a+') as label_file:
                label_file.write(str(l) + '\n')
                '''
