...
def get_slice_file_sequence(store_filepath, list_result, count, func_name, startline, filepath_all):
    ...
    for node in list_result:
        if node['type'] == 'Function':  # get the function name
            ...
            # print 'condition'
            raw = int(node['location'].split(':')[0]) - 1  # the row of this node
...
def api_slice():
    count = 1
    store_filepath = "/home/anderson/Desktop/expslice/"
    if not os.path.exists(store_filepath):
        os.makedirs(store_filepath)
    store_filepath = store_filepath + "api_slices.txt"
    f = open("/home/anderson/Desktop/exppoint/sensifunc_slice_points.pkl", 'rb')
...
def pointers_slice():
    ...
    if not os.path.exists(store_filepath):
        os.makedirs(store_filepath)
    store_filepath = store_filepath + "pointersuse_slices.txt"
    f = open("/home/anderson/Desktop/exppoint/pointuse_slice_points.pkl", 'rb')
...
def return_slice():
    ...
    if not os.path.exists(store_filepath):
        os.makedirs(store_filepath)
    store_filepath = store_filepath + "returnuse_slices.txt"
    f = open("/home/anderson/Desktop/exppoint/return_slice_points_new.pkl", 'rb')
    dict_unsliced_pointers = pickle.load(f)
    # print dict_unsliced_pointers
    f.close()
    record = []
...
def param_slice():
    ...
    if not os.path.exists(store_filepath):
        os.makedirs(store_filepath)
    store_filepath = store_filepath + "paramsuse_slices.txt"
    f = open("/home/anderson/Desktop/exppoint/param_slice_points_new.pkl", 'rb')
    dict_unsliced_pointers = pickle.load(f)
    # print dict_unsliced_pointers
    f.close()
    record = []
...
def arrays_slice():
    ...
    if not os.path.exists(store_filepath):
        os.makedirs(store_filepath)
    store_filepath = store_filepath + "arraysuse_slices.txt"
    f = open("/home/anderson/Desktop/exppoint/arrayuse_slice_points.pkl", 'rb')
    dict_unsliced_pointers = pickle.load(f)
    f.close()
...
def integeroverflow_slice():
    ...
    if not os.path.exists(store_filepath):
        os.makedirs(store_filepath)
    store_filepath = store_filepath + "integeroverflow_slices.txt"
    f = open("/home/anderson/Desktop/exppoint/integeroverflow_slice_points_new.pkl", 'rb')
